...
public:
    ...
    const Book *getBook(const String &title) const;
    ...
    bool insertPageToBook(unsigned bookId, const Page &page, int pageNum);
    ...
    bool deletePageFromBook(unsigned bookId, int pageNumber);
};
